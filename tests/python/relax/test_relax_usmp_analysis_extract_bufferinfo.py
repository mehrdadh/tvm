...
class LinearStructure:
    ...
    def main(input: R.Tensor((16, 16), "uint8")) -> R.Tensor:
        ...
        lv0 = R.call_tir("tvmgen_default_fused_cast_subtract", (input, tsid_10), (301056, 1), dtype="int32")
        lv1 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast", (lv0, tsid_11, tsid_12), (802816, 1), dtype="int32")
        output = R.call_tir("tvmgen_default_fused_nn_max_pool2d_cast", (lv1), (16, 16), dtype="int32")
        return output
# fmt: on
...
class ParallelSerialMixedForLoops:
    ...
    def main(input: R.Tensor((512, 512), "uint8")) -> R.Tensor:
        ...
        output = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_1", (input, tsid_10, tsid_11), (262144, 1), dtype="int32")
        return output
# fmt: on
...
class InceptionStructure:
    ...
    def main(input: R.Tensor((16, 16), "uint8")) -> R.Tensor:
        ...
        sid_8 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast", (sid_9, tsid_100, tsid_101), (802816, 1), dtype="int32")
        sid_7 = R.call_tir("tvmgen_default_fused_nn_max_pool2d_cast", (sid_8), (401408, 1), dtype="int32")
        sid_6 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast", (sid_7, tsid_100, tsid_101), (401408, 1), dtype="int32")
        sid_5 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_1", (sid_6, tsid_100, tsid_101), (602112, 1), dtype="int32")
        sid_4 = R.call_tir("tvmgen_default_fused_nn_max_pool2d", (sid_5), (150528, 1), dtype="int32")
        sid_3 = R.call_tir("tvmgen_default_fused_cast", (sid_4), (301056, 1), dtype="int32")
        sid_2 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_2", (sid_3, tsid_100, tsid_101), (50176, 1), dtype="int32")
        sid_20 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast_1", (sid_3, tsid_100, tsid_101), (150528, 1), dtype="int32")
        sid_19 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast_fixed_point_multiply_cli_4464294615199028320_", (sid_20, tsid_100, tsid_101), (100352, 1), dtype="int32")
        sid_26 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast_2", (sid_3, tsid_100, tsid_101), (25088, 1), dtype="int32")
        sid_25 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast_fixed_point_multiply_cli_4464294615199028320__1", (sid_26, tsid_100, tsid_101), (25088, 1), dtype="int32")
        sid_32 = R.call_tir("tvmgen_default_fused_nn_max_pool2d_cast_1", (sid_4), (301056, 1), dtype="int32")
        sid_31 = R.call_tir("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast_fixed_point_multiply_cli_4464294615199028320__2", (sid_32, tsid_100, tsid_101), (25088, 1), dtype="int32")
        output = R.call_tir("tvmgen_default_fused_concatenate", (sid_2, sid_19, sid_25, sid_31), (25088, 1), dtype="int32")
        return output
# fmt: on
...
class MultipleCallsToSamePrimFuncModule:
    ...
    def main(input: R.Tensor((16, 16), "uint8")) -> R.Tensor:
        ...
        sid_8 = R.builtin.alloc_tensor((3456, 1), runtime_device_index=0, dtype="int8")

        sid_23 = R.call_tir("tvmgen_default_fused_layout_transform_1", (input), (2, 1), dtype="int32")
        sid_7 = R.call_tir("tvmgen_default_fused_nn_contrib_conv2d_NCHWc", (sid_8, tsid_100), (3456, 1), dtype="int32")
        sid_6 = R.call_tir("tvmgen_default_fused_layout_transform", (sid_7), (3456, 1), dtype="int32")
        sid_12 = R.call_tir("tvmgen_default_fused_reshape_1", (input), (3456, 1), dtype="int32")
        sid_11 = R.call_tir("tvmgen_default_fused_nn_contrib_dense_pack_nn_relu", (sid_12, tsid_100), (3456, 1), dtype="int32")
        sid_10 = R.call_tir("tvmgen_default_fused_reshape", (sid_11), (3456, 1), dtype="int32")
        sid_5 = R.call_tir("tvmgen_default_fused_nn_softmax_add_add_multiply_add", (sid_6, sid_10, tsid_100, tsid_101, tsid_102), (3456, 1), dtype="int32")
        sid_4 = R.call_tir("tvmgen_default_fused_layout_transform_1", (sid_5), (3456, 1), dtype="int32")
        sid_3 = R.call_tir("tvmgen_default_fused_nn_contrib_conv2d_NCHWc", (sid_4, tsid_100), (3456, 1), dtype="int32")
        sid_2 = R.call_tir("tvmgen_default_fused_layout_transform", (sid_3), (3456, 1), dtype="int32")
        sid_20 = R.call_tir("tvmgen_default_fused_reshape_1", (sid_5), (3456, 1), dtype="int32")
        sid_19 = R.call_tir("tvmgen_default_fused_nn_contrib_dense_pack_nn_relu", (sid_20, tsid_100), (3456, 1), dtype="int32")
        sid_18 = R.call_tir("tvmgen_default_fused_reshape", (sid_19), (3456, 1), dtype="int32")
        output = R.call_tir("tvmgen_default_fused_nn_softmax_add", (sid_2, sid_18), (3456, 1), dtype="int32")
        return output
# fmt: on
